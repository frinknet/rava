...
int ray_fs_cwd(lua_State* L) {
  ...
  int err = uv_cwd(buffer, (size_t*) RAY_MAX_PATH);
  if (err) {
...
static luaL_Reg ray_funcs[] = {
  ...
  {"udp",       ray_udp_new},
 /*fs*/ {"open",      ray_fs_open},
 /*fs*/ {"unlink",    ray_fs_unlink},
 /*fs*/ {"mkdir",     ray_fs_mkdir},
 /*fs*/ {"rmdir",     ray_fs_rmdir},
 /*fs*/ {"scandir",   ray_fs_scandir},
 /*fs*/ {"stat",      ray_fs_stat},
 /*fs*/ {"rename",    ray_fs_rename},
 /*fs*/ {"sendfile",  ray_fs_sendfile},
 /*fs*/ {"chmod",     ray_fs_chmod},
 /*fs*/ {"chown",     ray_fs_chown},
 /*fs*/ {"utime",     ray_fs_utime},
 /*fs*/ {"lstat",     ray_fs_lstat},
 /*fs*/ {"link",      ray_fs_link},
 /*fs*/ {"symlink",   ray_fs_symlink},
 /*fs*/ {"readlink",  ray_fs_readlink},
 /*fs*/ {"cwd",       ray_fs_cwd},
 /*fs*/ {"chdir",     ray_fs_chdir},
 /*fs*/ {"exepath",   ray_fs_exepath},
 /*sys*/ {"cpu_info",  ray_cpu_info},
 /*sys*/ {"mem_free",  ray_mem_free},
 /*sys*/ {"mem_total", ray_mem_total},
 /*sys*/ {"hrtime",    ray_hrtime},
 /*sys*/ {"interfaces",ray_interfaces},
 /*dns*/ {"getaddrinfo",ray_getaddrinfo},
  {"run",       ray_run},
  {NULL,        NULL}
};
